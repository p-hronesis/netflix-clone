...
<h3 align="center">Netflix clone app</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/p-hronesis/netflix-clone" target="_blank"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://netflix-clone-1cul.vercel.app/" target="_blank">View Demo</a>
    ·
    <a href="https://github.com/p-hronesis/netflix-clone/issues/new?labels=bug&template=bug-report---.md" target="_blank">Report Bug</a>
    ·
    <a href="https://github.com/p-hronesis/netflix-clone/issues/new?labels=enhancement&template=feature-request---.md" target="_blank">Request Feature</a>
  </p>
</div>
...
[![Product Name Screen Shot][product-screenshot]](https://netflix-clone-1cul.vercel.app/)

This is a very minimalistic Netflix clone app that implements some basic functionalities of netflix and it user interface.
...
### Features
  ...
  <ul>
    ...
    <b>Pages and routes protection</b>
      <p>
      The <a href="https://netflix-clone-1cul.vercel.app/" target="_blank">home</a> and the <a href="https://netflix-clone-1cul.vercel.app/profiles">profiles</a> pages are protected with the getServerSideProps function and redirects to the <a href="https://netflix-clone-1cul.vercel.app/auth" target="_blank">auth page</a>. Also api routes like <a href="https://netflix-clone-1cul.vercel.app/api/movies" target="_blank">/api/movies</a>, <a href="https://netflix-clone-1cul.vercel.app/api/favorites" target="_blank">/api/favorites</a>, <a href="https://netflix-clone-1cul.vercel.app/api/favorite" target="_blank">/api/favorite</a> and many more are protected too.
      Only logged in users can access this protected routes
      </p>
...
This is the list of some of the plugins and frameworks I used, check the <a href="https://github.com/p-hronesis/netflix-clone/blob/master/package.json" target="_blank">package.json</a> for a complete list.
...
[Lodash-image]: https://img.shields.io/badge/lodash-20232A?style=for-the-badge&logo=lodash&logoColor=white
...
- [![Lodash][Lodash-image]][Lodash-url]
...
1. Clone the repo:
   ```sh
   git clone https://github.com/p-hronesis/netflix-clone.git
   ```
...
This project allows users to browse and play movies, manage their profile, and favorite movies. It also allows user to register with their email and password or use their google/github account for signup and sign in.
...
- [ ] Improve movie recommendation algorithm
...
See the [open issues](https://github.com/p-hronesis/netflix-clone/issues) for a full list of proposed features and known issues.
...
Project Link: [https://github.com/p-hronesis/netflix-clone](https://github.com/p-hronesis/netflix-clone)
